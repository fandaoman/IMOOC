...
<!-- Meta tag Keywords -->
<!-- css files  -->
<link href="fdm/css/error/style.css" rel="stylesheet" type="text/css" media="all">
<link href="fdm/css/error/font-awesome.min.css" rel="stylesheet" type="text/css" media="all">
<!-- online-fonts -->
<link href="http://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i&subset=cyrillic,cyrillic-ext,greek,greek-ext,latin-ext,vietnamese" rel="stylesheet">
<!--//online-fonts -->
<body>
<div class="header">
	<h1>dark error page</h1>
</div>
<div class="w3-main">
	<div class="agile-info">
		...
		<a href="fdm/user/login.jsp">go back</a>
	</div>
</div>
